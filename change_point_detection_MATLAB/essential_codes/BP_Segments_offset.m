function[Segments] = BP_Segments_offset(xData, yData, CP_positions, varargin)
    ...
    for i = 1:(NSegments)
        ...
        Segments(i,5:6) = BP_lingress_offset(yData, range(1), range(2)-range(1));
        Segments(i,7:8) = NaN(1,2);
        Segments(i,[2 4]) = Segments(i,5);
