...
plt.tight_layout()
plt.savefig('/Users/longfu/Library/CloudStorage/Dropbox/3-T7 DNAp_Nat Com～working/SI_data/comparison-single-transitional_pol-event'+'.eps', format='eps', dpi=300, bbox_inches='tight')
plt.show()
